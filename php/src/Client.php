...
namespace APIVerve\Heicconverter;
...
/**
 * Client for the HEIC Converter API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/heicconverter?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/heicconverter';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\HeicconverterClient] {$message}\n";
        }
    }
}

...
class heicconverterWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/heicconverter');
        }
        ...
        this.validationRules = {"image":{"type":"string","required":true},"outputFormat":{"type":"string","required":true},"quality":{"type":"integer","required":false,"min":1,"max":100,"default":90},"maxWidth":{"type":"integer","required":false,"min":1,"max":10000},"maxHeight":{"type":"integer","required":false,"min":1,"max":10000}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/heicconverter`);
        }
    }
    ...
    async executeWithFile(file, options = {}, callback) {
        ...
        if (!file) {
            throw new Error('File must be provided for file upload. See documentation: https://docs.apiverve.com/ref/heicconverter');
        }
        ...
        if (typeof file === 'string') {
            ...
            throw new Error('File must be a file path (string), Buffer, or ReadStream. See documentation: https://docs.apiverve.com/ref/heicconverter');
        }
    ...
    async executeWithUrl(url, options = {}, callback) {
        ...
        if (!url || typeof url !== 'string') {
            throw new Error('URL must be provided as a string. See documentation: https://docs.apiverve.com/ref/heicconverter');
        }
...
module.exports = heicconverterWrapper;

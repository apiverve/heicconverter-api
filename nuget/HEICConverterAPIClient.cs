...
namespace APIVerve.API.HEICConverter
{
    ...
    /// <summary>
    /// Client for the HEICConverter API
    /// </summary>
    public class HEICConverterAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/heicconverter";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "outputFormat", new ValidationRule { Type = "string", Required = true } },
            { "quality", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 100 } },
            { "maxWidth", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 10000 } },
            { "maxHeight", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 10000 } }
        };
        ...
        public HEICConverterAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public HEICConverterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public HEICConverterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, HEICConverterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(HEICConverterQueryOptions options)
        {
        ...
        public ResponseObj Execute(HEICConverterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(HEICConverterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(HEICConverterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(HEICConverterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(HEICConverterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(HEICConverterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(HEICConverterQueryOptions options)
        {

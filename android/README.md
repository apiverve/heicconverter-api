...
```gradle
dependencies {
    implementation 'com.github.apiverve:heicconverter-api:1.1.13'
}
```
...
```java
import com.apiverve.heicconverter.HEICConverterAPIClient;
import com.apiverve.heicconverter.APIResponse;
import com.apiverve.heicconverter.APIException;

// Initialize the client
HEICConverterAPIClient client = new HEICConverterAPIClient("YOUR_API_KEY");
...
This API requires a file upload. Supported file types: .heic, .heif (max 10MB)
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/heicconverter](https://docs.apiverve.com/ref/heicconverter)
...
- **Documentation:** [https://docs.apiverve.com/ref/heicconverter](https://docs.apiverve.com/ref/heicconverter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/heicconverter-api/issues)

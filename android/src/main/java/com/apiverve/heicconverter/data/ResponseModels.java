...
//
//     HEICConverterData data = Converter.fromJsonString(jsonString);

package com.apiverve.heicconverter.data;
...
public class Converter {
    ...
    public static HEICConverterData fromJsonString(String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    public static String toJsonString(HEICConverterData obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.readerFor(HEICConverterData.class);
        writer = mapper.writerFor(HEICConverterData.class);
    }
...
public class HEICConverterData {
    private UUID id;
    ...
    @JsonProperty("outputSize")
    public void setOutputSize(long value) { this.outputSize = value; }

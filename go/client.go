...
const (
	baseURL        = "https://api.apiverve.com/v1/heicconverter"
	defaultTimeout = 30 * time.Second
)

// Client is the HEIC Converter API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new HEIC Converter API client.
...
// ExecuteWithFile makes a request to the HEIC Converter API with a file upload.
...
// Execute makes a request to the HEIC Converter API with typed parameters.
//

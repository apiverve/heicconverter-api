// Package heicconverter provides a Go client for the HEIC Converter API.
//
// For more information, visit: https://apiverve.com/marketplace/heicconverter?utm_source=go&utm_medium=readme
package heicconverter
...
// Request contains the parameters for the HEIC Converter API.
//
// Parameters:
//   - image (required): string - Upload a HEIC or HEIF image file to convert
...
type Request struct {
	...
	OutputFormat string `json:"outputFormat"` // Required
	Quality int `json:"quality,omitempty"` // Optional
	MaxWidth int `json:"maxWidth,omitempty"` // Optional
	MaxHeight int `json:"maxHeight,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"quality": {Type: "integer", Required: false, Min: float64Ptr(1), Max: float64Ptr(100)},
		"maxWidth": {Type: "integer", Required: false, Min: float64Ptr(1), Max: float64Ptr(10000)},
		"maxHeight": {Type: "integer", Required: false, Min: float64Ptr(1), Max: float64Ptr(10000)},
	}
...
// ResponseData contains the data returned by the HEIC Converter API.

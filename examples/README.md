# HEIC Converter API - Examples

This folder contains example code for using the HEIC Converter API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/heicconverter',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/heicconverter");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/heicconverter](https://docs.apiverve.com/ref/heicconverter)
